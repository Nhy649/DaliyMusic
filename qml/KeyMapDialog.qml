                    ...
                    ColumnLayout{
                        ...
                        RowLayout{
                            ...
                            TextField{
                                id: stopText
                                Layout.fillWidth: true
                                text: actions.stopAction.shortcut===undefined?" ":actions.stopAction.shortcut
                            }
                        }
                        RowLayout{
                            width: parent.width-10
                    ...
                    ColumnLayout{
                        ...
                        RowLayout{
                            ...
                            TextField{
                                id: seqPlayText
                                Layout.fillWidth: true
                                text: actions.seqPlayAction.shortcut===undefined?" ":actions.seqPlayAction.shortcut
                            }
                        }
                        RowLayout{
                            width: parent.width-10
                ...
                ColumnLayout{
                    ...
                    RowLayout{
                        ...
                        TextField{
                            id: recentlyPlayText
                            Layout.fillWidth: true
                            text: actions.recentlayPlaydAction.shortcut===undefined?" ":actions.recentlayPlaydAction.shortcut
                        }
                    }
                    RowLayout{
                        width: parent.width-10
        ...
        RowLayout{
            ...
            Button{
                ...
                onClicked: {
                    ...
                    actions.stopAction.shortcut = stopText.text
                    ...
                    actions.seqPlayAction.shortcut = seqPlayText.text
                    ...
                    actions.recentlayPlaydAction.shortcut = recentlyPlayText.text
